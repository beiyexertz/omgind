...
func Status(v int32) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusEQ(v int32) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatus), v))
	})
}
...
func StatusNEQ(v int32) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusIn(vs ...int32) predicate.SysJwtBlock {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusNotIn(vs ...int32) predicate.SysJwtBlock {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusGT(v int32) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusGTE(v int32) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusLT(v int32) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusLTE(v int32) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {

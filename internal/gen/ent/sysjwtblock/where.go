...
func Status(v int) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusEQ(v int) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatus), v))
	})
}
...
func StatusNEQ(v int) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusIn(vs ...int) predicate.SysJwtBlock {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusNotIn(vs ...int) predicate.SysJwtBlock {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusGT(v int) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusGTE(v int) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusLT(v int) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {
...
func StatusLTE(v int) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(func(s *sql.Selector) {

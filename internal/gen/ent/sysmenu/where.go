...
func ID(id pulid.ID) predicate.SysMenu {
...
func IDEQ(id pulid.ID) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id pulid.ID) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func IDIn(ids ...pulid.ID) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func IDNotIn(ids ...pulid.ID) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id pulid.ID) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func IDGTE(id pulid.ID) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func IDLT(id pulid.ID) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func IDLTE(id pulid.ID) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func Status(v int32) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func StatusEQ(v int32) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatus), v))
	})
}
...
func StatusNEQ(v int32) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func StatusIn(vs ...int32) predicate.SysMenu {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusNotIn(vs ...int32) predicate.SysMenu {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusGT(v int32) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func StatusGTE(v int32) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func StatusLT(v int32) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {
...
func StatusLTE(v int32) predicate.SysMenu {
	return predicate.SysMenu(func(s *sql.Selector) {

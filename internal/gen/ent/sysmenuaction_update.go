...
func (smau *SysMenuActionUpdate) SetStatus(i int32) *SysMenuActionUpdate {
...
func (smau *SysMenuActionUpdate) SetNillableStatus(i *int32) *SysMenuActionUpdate {
	if i != nil {
		smau.SetStatus(*i)
	}
	return smau
...
func (smau *SysMenuActionUpdate) AddStatus(i int32) *SysMenuActionUpdate {
...
// SetStatus sets the "status" field.
func (smauo *SysMenuActionUpdateOne) SetStatus(i int32) *SysMenuActionUpdateOne {
...
// SetNillableStatus sets the "status" field if the given value is not nil.
func (smauo *SysMenuActionUpdateOne) SetNillableStatus(i *int32) *SysMenuActionUpdateOne {
	if i != nil {
		smauo.SetStatus(*i)
	}
	return smauo
...
// AddStatus adds i to the "status" field.
func (smauo *SysMenuActionUpdateOne) AddStatus(i int32) *SysMenuActionUpdateOne {

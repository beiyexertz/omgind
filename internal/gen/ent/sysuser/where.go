...
func ID(id pulid.ID) predicate.SysUser {
...
func IDEQ(id pulid.ID) predicate.SysUser {
	return predicate.SysUser(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id pulid.ID) predicate.SysUser {
	return predicate.SysUser(func(s *sql.Selector) {
...
func IDIn(ids ...pulid.ID) predicate.SysUser {
	return predicate.SysUser(func(s *sql.Selector) {
...
func IDNotIn(ids ...pulid.ID) predicate.SysUser {
	return predicate.SysUser(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id pulid.ID) predicate.SysUser {
	return predicate.SysUser(func(s *sql.Selector) {
...
func IDGTE(id pulid.ID) predicate.SysUser {
	return predicate.SysUser(func(s *sql.Selector) {
...
func IDLT(id pulid.ID) predicate.SysUser {
	return predicate.SysUser(func(s *sql.Selector) {
...
func IDLTE(id pulid.ID) predicate.SysUser {
	return predicate.SysUser(func(s *sql.Selector) {

...
import (
	...
	"github.com/wanhello/omgind/internal/app/model/entcd/predicate"
...
func (srq *SysRoleQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (srq *SysRoleQuery) FirstIDX(ctx context.Context) int {
...
func (srq *SysRoleQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (srq *SysRoleQuery) OnlyIDX(ctx context.Context) int {
...
func (srq *SysRoleQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (srq *SysRoleQuery) IDsX(ctx context.Context) []int {
	ids, err := srq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (srq *SysRoleQuery) prepareQuery(ctx context.Context) error {
	for _, f := range srq.fields {
		if !sysrole.ValidColumn(f) {
			return &ValidationError{Name: f, err: fmt.Errorf("entcd: invalid field %q for query", f)}
		}
	}
	if srq.path != nil {
...
func (srq *SysRoleQuery) sqlAll(ctx context.Context) ([]*SysRole, error) {
	...
	_spec.Assign = func(columns []string, values []interface{}) error {
		if len(nodes) == 0 {
			return fmt.Errorf("entcd: Assign called without calling ScanValues")
		}
...
func (srq *SysRoleQuery) sqlExist(ctx context.Context) (bool, error) {
	...
	if err != nil {
		return false, fmt.Errorf("entcd: check existence: %w", err)
	}
	return n > 0, nil
}
...
func (srgb *SysRoleGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(srgb.fields) > 1 {
		return nil, errors.New("entcd: SysRoleGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := srgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (srgb *SysRoleGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{sysrole.Label}
	default:
		err = fmt.Errorf("entcd: SysRoleGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (srgb *SysRoleGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(srgb.fields) > 1 {
		return nil, errors.New("entcd: SysRoleGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := srgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (srgb *SysRoleGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{sysrole.Label}
	default:
		err = fmt.Errorf("entcd: SysRoleGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (srgb *SysRoleGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(srgb.fields) > 1 {
		return nil, errors.New("entcd: SysRoleGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := srgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (srgb *SysRoleGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{sysrole.Label}
	default:
		err = fmt.Errorf("entcd: SysRoleGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (srgb *SysRoleGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(srgb.fields) > 1 {
		return nil, errors.New("entcd: SysRoleGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := srgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (srgb *SysRoleGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{sysrole.Label}
	default:
		err = fmt.Errorf("entcd: SysRoleGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (srs *SysRoleSelect) Strings(ctx context.Context) ([]string, error) {
	if len(srs.fields) > 1 {
		return nil, errors.New("entcd: SysRoleSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := srs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (srs *SysRoleSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{sysrole.Label}
	default:
		err = fmt.Errorf("entcd: SysRoleSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (srs *SysRoleSelect) Ints(ctx context.Context) ([]int, error) {
	if len(srs.fields) > 1 {
		return nil, errors.New("entcd: SysRoleSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := srs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (srs *SysRoleSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{sysrole.Label}
	default:
		err = fmt.Errorf("entcd: SysRoleSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (srs *SysRoleSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(srs.fields) > 1 {
		return nil, errors.New("entcd: SysRoleSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := srs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (srs *SysRoleSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{sysrole.Label}
	default:
		err = fmt.Errorf("entcd: SysRoleSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (srs *SysRoleSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(srs.fields) > 1 {
		return nil, errors.New("entcd: SysRoleSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := srs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (srs *SysRoleSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{sysrole.Label}
	default:
		err = fmt.Errorf("entcd: SysRoleSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

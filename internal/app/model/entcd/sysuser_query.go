...
func (suq *SysUserQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (sugb *SysUserGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sugb.fields) > 1 {
		return nil, errors.New("entcd: SysUserGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sugb *SysUserGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{sysuser.Label}
	default:
		err = fmt.Errorf("entcd: SysUserGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sugb *SysUserGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sugb.fields) > 1 {
		return nil, errors.New("entcd: SysUserGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sugb *SysUserGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{sysuser.Label}
	default:
		err = fmt.Errorf("entcd: SysUserGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sugb *SysUserGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sugb.fields) > 1 {
		return nil, errors.New("entcd: SysUserGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sugb *SysUserGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{sysuser.Label}
	default:
		err = fmt.Errorf("entcd: SysUserGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sugb *SysUserGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sugb.fields) > 1 {
		return nil, errors.New("entcd: SysUserGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sugb *SysUserGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{sysuser.Label}
	default:
		err = fmt.Errorf("entcd: SysUserGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (sus *SysUserSelect) Strings(ctx context.Context) ([]string, error) {
	if len(sus.fields) > 1 {
		return nil, errors.New("entcd: SysUserSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := sus.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sus *SysUserSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{sysuser.Label}
	default:
		err = fmt.Errorf("entcd: SysUserSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sus *SysUserSelect) Ints(ctx context.Context) ([]int, error) {
	if len(sus.fields) > 1 {
		return nil, errors.New("entcd: SysUserSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := sus.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sus *SysUserSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{sysuser.Label}
	default:
		err = fmt.Errorf("entcd: SysUserSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sus *SysUserSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(sus.fields) > 1 {
		return nil, errors.New("entcd: SysUserSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := sus.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sus *SysUserSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{sysuser.Label}
	default:
		err = fmt.Errorf("entcd: SysUserSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sus *SysUserSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(sus.fields) > 1 {
		return nil, errors.New("entcd: SysUserSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := sus.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sus *SysUserSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{sysuser.Label}
	default:
		err = fmt.Errorf("entcd: SysUserSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
